    ...
    <div className="min-h-screen bg-background text-white flex flex-col items-center justify-center px-6 overflow-hidden relative">
      ...
      >
        ...
        <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
          Spectropy PMS is a specialized Project Management System designed for
          educational excellence. Manage your content, teams, and delivery
          pipelines with full visibility and smart analytics.
        </p>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
          <Link href="/auth">
            <Button
              size="lg"
              className="bg-primary hover:bg-indigo-600 text-white px-8 rounded-xl font-bold text-lg h-12 shadow-lg shadow-primary/20 transition-all hover:scale-105 active:scale-95"
            >
              Get Started
          ...
          <Link href="/auth">
            <Button
              size="lg"
              variant="outline"
              className="border-accent text-accent hover:bg-accent hover:text-black px-8 rounded-xl font-bold text-lg h-12 transition-all hover:scale-105 active:scale-95"
            >
              Register
            </Button>
          </Link>
