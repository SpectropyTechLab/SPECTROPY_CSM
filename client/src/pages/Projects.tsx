...
import { Plus, Search, Calendar, MoreVertical, Filter } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProjects?.map((project, index) => (
              <motion.div 
                ...
                className="glass-panel rounded-2xl p-6 group hover:border-primary/50 transition-colors"
              >
